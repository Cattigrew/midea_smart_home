    ...
    "22259041": {
        ...
        "entities": {
            ...
            Platform.SELECT: {
                ...
                "fresh_air_fan_speed": {
                    "options": {
                        "low": {"fresh_air_fan_speed": 40},
                        "mid": {"fresh_air_fan_speed": 60},
                        "high": {"fresh_air_fan_speed": 80},
                        "strong": {"fresh_air_fan_speed": 100}
                    }
                },
                "inner_purifier_fan_speed": {
                    "options": {
                        "low": {"inner_purifier_fan_speed": 40},
                        "mid": {"inner_purifier_fan_speed": 60},
                        "high": {"inner_purifier_fan_speed": 80},
                        "strong": {"inner_purifier_fan_speed": 100}
                    }
                }
            },
            Platform.SWITCH: {
    ...
    "22019053": {
        ...
        "entities": {
            ...
            Platform.SENSOR: {
               ...
               "fresh_filter_time_use": {
                    "state_class": SensorStateClass.MEASUREMENT,
                    "translation_key": "fresh_filter_time_used"
                }
            }
        }
    },
