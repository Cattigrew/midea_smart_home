...
5. 如果使用 Docker，确保网络模式为 `host` 或正确配置端口转发
6. 部分设备可能需要先在美的美居 App 中完成固件升级
...
1. 检查美的美居账号密码是否正确
2. 确认设备已绑定到当前账号
3. 检查Home assistant版本是否不低于2025.12.4
4. 如果问题持续存在，请提交 Issue 反馈

### Q: 设备显示但无法控制？

**解决方案**：
1. 检查设备是否在线（在美的美居 App 中查看）
2. 尝试重新加载集成
3. 如果是新设备类型，可能尚未支持，请提交 Issue 反馈
